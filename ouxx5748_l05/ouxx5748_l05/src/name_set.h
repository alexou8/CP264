...
/**
 * Print the contents of the linked set of names, one name per line in the format:<br/>
...
/**
 * Appends a name to sourcer, but only if the name is not already present in source.
